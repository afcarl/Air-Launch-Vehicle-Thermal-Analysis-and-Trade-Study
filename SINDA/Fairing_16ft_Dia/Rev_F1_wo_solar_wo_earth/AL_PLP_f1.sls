...
(C) COPYRIGHT 1982-2006 J.D.GASKI SINDA/G VERSION-'2.5.000 - NETWORK ANALYSIS, INC.
 ...
 Cc       CAL  6000, 6000,    3, 19.0, 19.0, 1.929E-6, 1.0                       
  ...
  COND ANALYSIS - CONST=      4, VARB=      7 TOTAL=     11, EFF=     11, LIN=      7, RAD=      4, O/W=      0, NLG=      7
 ...
 *** NOTE: SEGMENT SIZE =    33333287 - INFO ONLY

 *** PSEUDO COMPUTE SEQUENCE 1 LENGTH IS      91, PSEUDO COMPUTE SEQUENCE 2 LENGTH IS      42, TOTAL IS      133
(C) COPYRIGHT 1982-2006 J.D.GASKI SINDA/G VERSION-2.5.000 - NETWORK ANALYSIS, INC.
  AL PLP Proposal Study (For Jim Berry, 07/17/08)       Modified by A.Carl: (From: SAMTAV Task Order 9  06/24            
